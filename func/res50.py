...
from function_lib import ResNetBackbone, UniversalDeepLabV3Plus, CustomDiceCELoss, PureResNet50_FCN
...
# 想要跑 ResNet50 基线模型
model = PureResNet50_FCN(out_channels=1, spatial_dims=2).to(device)
